...
var I18N = {
  fa: {
    ...
    telemirror_title: 'دیدن کانال‌های دلخواه (teleMirror)',
    telemirror_disclaimer: 'روش باز کردن کانال‌های دلخواه در این بخش فقط تا زمانی که سرویس‌های گوگل باز باشن کار می‌کنه. اگر براتون کار نکرد، از قابلیت‌های اصلی thefeed استفاده کنید چون ضدفیلتر هستن.',
    ...
    default_configs: 'کانفیگ‌های پیش‌فرض', already_imported: 'وارد شده', update: 'بروزرسانی',
    update_success: 'پروفایل «{d}» بروزرسانی شد.',
    ...
    chat_err_no_key: 'این پروفایل کلید عمومی سرور (sk) ندارد؛ پیام‌رسان بدون آن فعال نمی‌شود.',
  ...
  en: {
    ...
    telemirror_title: 'Browse channels (teleMirror)',
    ...
    default_configs: 'Default configs', already_imported: 'Imported', update: 'Update',
    update_success: 'Updated profile "{d}".',
    ...
    chat_err_no_key: 'This profile has no server public key (sk); the messenger stays off without it.',
    ...
    chat_experimental: 'Experimental',
    cancel: 'Cancel',
